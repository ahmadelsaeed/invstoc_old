...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    var this_site_url=$(".url_class_2").val();
    var cdn = {
        defaultBase: "/public_html/front/js/emoji/",
        defaultBase3: "/public_html/front/js/emoji/",
        base: null,
        isLoading: false
    };
    function loadEmojione(options) {
        ...
        if (!cdn.isLoading) {
            if (!emojione || getSupportMode(detectVersion(emojione)) < 2) {
                ...
                $.ajax({
                    url:this_site_url+"/public_html/front/js/emoji/emojione.min.js",
                    dataType: "script",
                    cache: true,
                    success: function () {
        ...
        emojioneReady(function() {
            ...
            if (options.useInternalCDN) {
                ...
                emojione.imagePathPNG = cdn.base+ emojiSize;

                        ...
                        <tr>
                            <td style="padding:10px;font-size:14px; width:100%;">
                                <p>
                                    ...
                                    <br>
                                    <br>
                                    According to your request to get your referrer link.
                                    <br><br>

                                    Congratulation we have accepted your request and below is your link :-
                                    <br><br>
                                    <b>
                                        <a href="{{url("$referrer_link")}}">{{url("$referrer_link")}}</a>
                                    </b>

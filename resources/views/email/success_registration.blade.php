<style>
    ...
    .footer_social_icon_link:hover{
        text-decoration: none;
    }

    .footer_social_icon_link .fa{
        width: 22px;
        padding: 6px;
        color: #009146;
    }
                        ...
                        <tr>
                            <td style="padding:10px;font-size:14px; width:100%;">
                                <p>
                                    ...
                                    <br>
                                    <br>
                                    {!! success_verification_email_body !!} <b>{{$code}}</b>
                                    <br>
                                    <a href="{{url("/")}}" target="_blank"> {{ success_verification_login_now }} </a>
                                    <br>
                                </p>
                            </td>
                        </tr>
                                        ...
                                        <?php if(isset($social_imgs) && is_array($social_imgs) && count($social_imgs)): ?>
                                            <?php foreach($social_imgs as $key => $social_img): ?>
                                                <li style="float: left;padding: 0px 5px;margin-bottom: 5px;text-align: center;width: 35px;height: 35px;line-height: 40px;border-radius: 2px;">
                                                    <a class="footer_social_icon_link" style="color: #FFF;text-decoration: none;width: 100%;padding: 5px;"

...
@section('group_subview')
    ...
    <div class="panel panel-info">
        <div class="panel-heading">Remove {{$member_data->full_name}}</div>
        <div class="panel-body">

            <form action="{{url(strtolower(session('language_locale', 'en'))."/group/remove_member/$group_obj->group_name/$group_obj->group_id?member_id=$member_data->g_m_id")}}" method="post">

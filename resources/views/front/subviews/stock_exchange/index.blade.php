<div class="container">
    <div class="row">
        ...
        <main class="col col-xl-9 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
            ...
            ?>
             <hr>
            <div class="add-icon stock_exchange_icons " style="padding: 10px;">
               <table >
                   <tr>
            ...
            <!--  <div class="row ">
                <div class="col-md-3 col-xs-2">
                    <img src="{{(isset($events_keywords->strong_img->path)?get_image_or_default($events_keywords->strong_img->path):"")}}" /> {{show_content($events_keywords,"strong_label")}}
                </div>
                <div class="col-md-3 col-xs-2 ">
                  <img src="{{(isset($events_keywords->middle_img->path)?get_image_or_default($events_keywords->middle_img->path):"")}}" /> {{show_content($events_keywords,"middle_label")}}
                </div>
                <div class="col-md-3">
                   <img src="{{(isset($events_keywords->weak_img->path)?get_image_or_default($events_keywords->weak_img->path):"")}}" /> {{show_content($events_keywords,"weak_label")}}
                </div>
                <div class="col-md-3">
                    <img src="{{(isset($events_keywords->not_important_img->path)?get_image_or_default($events_keywords->not_important_img->path):"")}}" /> {{show_content($events_keywords,"not_important_label")}}
                </div>
            </div> -->
            ...
            <div class="select-time">
                ...
                <form action="{{url(strtolower(session('language_locale', 'en')) . '/'. "$url")}}">
                        ...
                        <div class="btn_new_sort">
                            <ul class="nav nav-pills row">
                                <li class="nav-item col-md-2">
                                    <a href="#" id="yesterday" class="nav-link text-center {{($target == "yesterday")?"active":""}}">{{show_content($events_keywords,"yesterday_label")}}</a>
                                </li>
                                <li class="nav-item col-md-2">
                                    <a href="#" id="today" class="nav-link text-center {{($target == "today")?"active":""}}">{{show_content($events_keywords,"today_label")}}</a>
                                </li>
                                <li class="nav-item col-md-2">
                                    <a href="#" id="tomorrow" class="nav-link text-center {{($target == "tomorrow")?"active":""}}">{{show_content($events_keywords,"tomorrow_label")}}</a>
                                </li>
                                <li class="nav-item col-md-2">
                                    <a href="#" id="week" class="nav-link text-center {{($target == "week")?"active":""}}">{{show_content($events_keywords,"this_week_label")}}</a>
                                </li>
                                <li class="nav-item col-md-2">
                                    <a href="#" id="next_week" class="nav-link text-center {{($target == "next_week")?"active":""}}">{{show_content($events_keywords,"next_week_label")}}</a>
                                </li>
                                <li class="nav-item col-md-2">
                                    <a href="#" id="range_date" class="nav-link text-center {{($target == "range_date")?"active":""}}"><i class="fa fa-calendar"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row range_date_container {{($target == "range_date")?"":"hide_div"}}">
                        ...
                        <div class="col-md-2">
                             <label for="end_date"><br></label>
                            <button class="btn btn-success search_stock_range form-control"><i class="fa fa-search"></i></button>
                        </div>
                    </div>

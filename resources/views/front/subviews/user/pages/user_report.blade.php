            ...
            <div class="col col-lg-12 col-sm-12 col-12">
                <div class="ui-block responsive-flex">
                    ...
                    <div class="ui-block-content">
                        <form action="{{url("$language_locale/report/user/$user_obj->user_id")}}">
                            <div class="row">
                                <div class="col-md-4">
                                    <label><b>{{show_content($user_profile_keywords,"from_date_label")}}</b></label>
                                    <input type="date" required="" class="form-control" name="from_date" value="{{(isset($_GET["from_date"])?$_GET["from_date"]:"")}}">
                                </div>

                                <div class="col-md-4">
                                    <label><b>{{show_content($user_profile_keywords,"to_date_label")}}</b></label>
                                    <input type="date" required="" class="form-control" name="to_date" value="{{(isset($_GET["to_date"])?$_GET["to_date"]:"")}}">
                                </div>

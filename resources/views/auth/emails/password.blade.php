                        ...
                        <tr>
                            <td style="padding:10px;font-size:14px; width:100%;">
                                <p>
                                    ...
                                    <br>
                                    <a href="{{ $link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}"> {{ reset_password_link }} </a>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div align="center"
                                    ...
                                    <ul style="list-style: none;margin: 0px;display: inline-block;">
                                        <?php
                                            $social_imgs = (array)json_decode(social_imgs);
                                            $social_links = (array)json_decode(social_links);
                                        ?>
